...
function App() {
  ...
  const recipesCollectionRef = collection(db, "recipe");
          ...
          <div className="recipe" key={recipe.id}>
            ...
            {recipe.viewing && (
              <div>
                <h4>Ingredients</h4>
                <ul>
                  {recipe.ingredients.map((ingredien, i) => (
                    <li key={i}>{ingredien}</li>
                  ))}
                </ul>
                <h4>Steps</h4>
                <ol>
            ...
            <div className="buttons">
              ...
              <button className="remove"  onClick={() => handleRemove(recipe.id)}>Remove</button>
            </div>
          </div>
        ))}
      </div>
