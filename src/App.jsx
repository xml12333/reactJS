  ...
  return (
    <div className="min-h-screen flex flex-col text-white">
      <main className="container mx-auto px-6 pt-16 flex-1 text-center">
        <h2 className="tex-2xl md:text-4xl lg:text-6xl uppercase">
          Welcome to
        </h2>
        <h2 className="tex-3xl md:text-6xl lg:text-8xl font-black uppercase mb-8">
          The codding club
        </h2>
        <div className="text-lg md:text-2xl lg:text-3xl py-2 px-4 md:py4 md:px-10 lg:py-6 lg:px-12 bg-white bg-opacity-10 w-fit mx-auto mb-8 rounded-full">
          943,234 members
        </div>
        <form
          action="https://www.getrevue.co/profile/app-brewery1/add_subscriber"
          method="post"
          id="revue-form"
          name="revue-form"
          target="_blank"
